...
["Gfx.setfullscreen","(bool)","F", "Set <b>true</b> or <b>false</b> to switch between window and fullscreen. Alpha feature, currently broken!"],
["Gfx.loadimage","(imagename:String)","P", "Loads a .PNG image from data/graphics/."],
...
["Gfx.resizeimage","(imagename:String, scale:Float)","F", "Resizes an image to a new size and stores it with the same label. (currently broken)"],
...
["Gfx.grabimagefromscreen","(imagename:String, screenx:Float, screeny:Float)","F","This function grabs a copy of the screen from position (screenx, screeny), and places it in the image. (doesn't currently work)"],
["Gfx.grabtilefromscreen","(tilesetname:String, tilenumber:Int, screenx:Float, screeny:Float)","F","This function grabs a tile from the screen at position (screenx, screeny), and places it in the tile. (doesn't currently work)"],
["Gfx.grabtilefromscreen","(tilesetname:String, tilenumber:Int, imagename:String, imagex:Float, imagey:Float)","F","This function grabs a tile from the image at position (imagex, imagey), and places it in the tile. (doesn't currently work)"],
["Gfx.grabimagefromimage","(imagetocopyto:String, sourceimage:String, sourceimagex:Float, sourceimagey:Float)","F", "This function grabs an image from another image at position (sourceimagex, sourceimagey), and places it in the new image. (doesn't currently work)"],
["Gfx.copytile","(totileset:String, totilenumber:Int, fromtileset:String, fromtilenumber:Int)","F", "Copies a tile from one tileset to another. If the source tile is larger than the destination tile, the tile is cropped. (doesn't currently work)"],
...
["Gfx.loadtiles","(tilesetname:String, tilewidth:Int, tileheight:Int)","P", "Loads a .PNG image from data/graphics/, and splits it into tiles."],
...
["Text.wordwrap","(width:Int)","F", "Sets the word-wrap width for Text.display() commands."],
...
["S.left","(currentstring:String, length:Int = 1):String","F","Return characters from the left of a string."],
["S.right","(currentstring:String, length:Int = 1):String","F","Return characters from the right of a string."],
["S.subtractfromleft","(currentstring:String, length:Int = 1):String","F","Take N characters from the left of a string and return it."],
