...
["Gfx.fillbox","(x:Float, y:Float, width:Float, height:Float, col:Int, alpha:Float = 1.0)","F", "Fill a box at (x, y) with given width, height, colour and alpha."],
...
["Gfx.imageheight","(imagename:String):Int","P", "Returns the height of an image."],
...
["Gfx.tileheight","(tilesetname:String):Int","P", "Returns the height of a tile in this tileset."],
...
["Input.justpressed","(k:Key):Bool","F","True if the key has been pressed this frame. (Use Key.ANY to check if any key is pressed this frame.)"],
["Input.pressed","(k:Key):Bool","F","True if this key is currently held down. (Use Key.ANY to check if any key is held down.)"],
["Input.justreleased","(k:Key):Bool","F","True if the key has been released this frame"],
["Input.forcerelease","(k:Key)","F","If the player is holding down this key, 'force' release it. Future calls to Input.pressed() will return false until the player lifts their finger and presses it again. If you call Input.forcerelease() without any parameters or with Key.ANY, it releases all keypresses."],
["Input.delaypressed","(k:Key, delay:Int):Bool","F","True once every N frames, if the key is pressed."],
["Input.pressheldtime","(k:Key):Int","F","Tells you how many frames a key has been pressed down for."],
...
["Input.keyname","(k:Key):String", "F", "Returns a string with the name of the given key. For example, Key.SEMICOLON returns <b>;</b>, Key.SPACE returns <b>Space</b>, Key.PAGEDOWN returns <b>Page Down</b>."],
...
["Geom.distance","(x1:Float, y1:Float, x2:Float, y2:Float):Float","F", "Returns the distance between the points (x1, y1) and (x2, y2)."],
["Geom.getangle","(x1:Float, y1:Float, x2:Float, y2:Float):Float","F", "Returns the angle (in degrees) between the points (x1, y1) and (x2, y2)."],
["Geom.anglebetween","(angle1:Float, angle2:Float):Float","F", "Returns the smallest difference between two angles, so that if you add the result to angle1, you get angle2. (All haxegon Geom functions use degrees.)"],
["Geom.clamp","(value:Float, min:Float, max:Float):Float","F", "Clamps a value between a min and max. If the value is less than min, return min, if it's more than max, return max, otherwise just return the value."],
["Geom.todegrees","(radians:Float):Float","F", "Converts radians to degrees. (All haxegon Geom functions use degrees.)"],
["Geom.toradians","(degrees:Float):Float","F", "Converts degrees to radians. (All haxegon Geom functions use degrees.)"],
["Geom.PI",":Float","F", "Is approximately equal to 3.141592653589793."],
["Geom.abs","(value:Float):Float","F", "Returns the absolute value of a number - if it's negative, return the positive of it - otherwise, don't change it. (Same as Math.abs().)"],
["Geom.acos","(value:Float):Float","F", "Returns the trigonometric arc cosine of the specified value in degrees. (Almost the same as Math.acos(), except that it returns degrees instead of radians.)"],
["Geom.asin","(value:Float):Float","F", "Returns the trigonometric arc sine of the specified value in degrees. (Almost the same as Math.asin(), except that it returns degrees instead of radians.)"],
["Geom.atan","(value:Float):Float","F", "Returns the trigonometric arc tangent of the specified value in degrees. (Almost the same as Math.atan(), except that it returns degrees instead of radians.)"],
